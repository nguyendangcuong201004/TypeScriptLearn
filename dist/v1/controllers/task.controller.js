...
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var find, sort, pagination, skip, regex, tasks;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (req.query.page && parseInt("".concat(req.query.page)) > 0) {
                ...
                return [4 /*yield*/, task_model_1.default.find(find).sort(sort).limit(pagination.limit).skip(skip)];
            case 1:
                tasks = _a.sent();
                res.json(tasks);
                return [2 /*return*/];
...
var changeStatus = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = "".concat(req.params.id);
                status_1 = "".concat(req.body.status);
